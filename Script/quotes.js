    ...
    const chunk = filtered.slice(i, i + 6);
        ...
        chunk.forEach(q => {
          ...
          <div class="col-md-4 mb-3">
                    <div class="quote-card h-100 shadow rounded p-2 d-flex flex-column justify-content-between"
            style="background-image: url('${getRandomPaper()}') !important;">
        
        <p class="quote-text flex-grow-1 mb-1">“${q.text}”</p>
        <p class="quote-author mt-0">– ${q.author_username || "Unknown"}</p>
